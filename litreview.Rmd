...
Most data can be represented by many different sets visual encodings [@wilkinson2012]. However, depending on our visualization goals, some sets of encodings can serve better to answer certain questions than others. By giving the user the ability to interactively switch between these representations, we empower them to explore the data more deeply and answer a wider range of questions [@yi2007].

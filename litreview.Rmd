...
Of course, with enough effort, users of these web-based visualization systems can still create rich interactive figures with advanced features such as complex linked views and parametric interaction. However, implementing these features often requires dealing with low-level reactivity and visualization primitives directly, defeating the purpose of using a high-level library and creating a barrier to entry for casual users [@keller2024]. This may explain why interactive visualizations are nowadays mainly used for data presentation, not data exploration [@batch2017].
...
@ward2015 outlined several common goals for creating interactive visualizations:
...
### Scales and measurement {#measurement}

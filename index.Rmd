...
bibliography: [references-formatted.bib]
link-citations: true
editor_options: 
...
pal_paired_3 <- palette.colors(6, "Paired")
pal_light_3 <- palette.colors(6, "Paired")[1:3]
pal_dark_3 <- palette.colors(6, "Paired")[2 * 1:3]

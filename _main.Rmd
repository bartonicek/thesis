...
Finally, all of this theoretical work would be for naught if it did not lead to practical insights. Specifically, despite its theoretical underpinnings, the end-goal of this work is applied: building robust and coherent interactive data visualization systems. Thus, to validate and refine the theoretical concepts, I also develop an original open-source interactive data visualization library.

Consequently, large parts of this thesis are also dedicated to the design considerations, architecture, and components of this system, along with its application to real-world data. 

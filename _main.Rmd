...
#   if (get_format() == "bookdown::pdf_document2") {
#     knitr::include_graphics(gsub(".html", ".png", path))
#   } else {
#     knitr::include_url(path)
#   }
# }
```
...
#| echo: false
#| eval: false
examples <- list.files("./figures") |> 
  (\(x) { x[startsWith(x, "example") & endsWith(x, ".html")] })()

urls <- paste0("./figures/", examples)
...
knitr::include_url("./figures/example-cases-stay-cat.html")
```
...
#| echo: false
#| out-extra: 'style="border: none;"'
knitr::include_url("./figures/example-cases-avg-days.html")
```
...
#| eval: true
#| out-extra: 'style="border: none;"'
knitr::include_url("./figures/example-cases-days-time.html")
```
...
#| eval: true
#| out-extra: 'style="border: none;"'
knitr::include_url("./figures/example-cases-days-time-zoom.html")
```
...
#| eval: true
#| out-extra: 'style="border: none;"'
knitr::include_url("./figures/example-cases-days-children.html")
```
...
knitr::include_url("./figures/example-cases-days-children-marked.html")
```
...
#| eval: true
#| out-extra: 'style="border: none;"'
knitr::include_url("./figures/example-cases-days-age.html")
```
...
knitr::include_url("./figures/example-cases-diagnosis.html")
```
...
#| eval: true
#| out-extra: 'style="border: none;"'
knitr::include_url("./figures/example-cases-diagnosis-time.html")
```
...
knitr::include_url("./figures/example-cases-diagnosis-max.html")
```

...
# Adds a histogram, modifying the figure in place
scene |> add_histogram(c("disp"))

# Sets the scatterplot's lower x-axis limit to 0, also in place 
scene |> set_scale("plot1", "x", min = 0)

# Selects cases corresponding to rows 1 to 10
scene |> select_cases(1:10)

# Query selected cases - returns their indices

...
Thus, the process of splitting our data into subsets may appear fairly straightforward. However, it does raise two fundamental questions:
...
In our concrete case of the preorder of data subsets ordered by inclusion, we can easily reuse the same diagram from Section \@ref(plots-as-preorders), that is, Figure \@ref(fig:barplot-preorder), and re-intepret it as a category:

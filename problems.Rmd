...
For the reasons outlined above, I decided to dedicate this section to the problem of applied scaling. The information here is based largely on how scales have been implemented in existing data visualization codebases, such as the `ggplot2` R package [@wickham2016] or `d3-scale` module of D3 [@d3-scale2024; also used by Vega @satyanarayan2015], as well as on personal insights gained while implementing my package.
...
#### A high-level model of scale implementation {#proposed-model}

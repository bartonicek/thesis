...
One of the most common and typical example of a scale is one where both $D$ and $V$ are subsets of the real numbers:
...
Simple scale functions like the linear mapping above can work fine for basic data visualization systems. However, once we begin adding more features, this design becomes prohibitive. Consider, for example, what happens if we want to:

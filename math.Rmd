...
#### Isomporphisms in categories {#isomorphism}

Before we go on to discuss specific examples of categories, there is one more important concept we need to discuss. We have been speaking of isomorphism as a bijection that "preserves structure". Now it is time to define what this means, and categories provide a good way to do this:

...
\begin{quote}
\emph{Note: A live version of this thesis featuring fully interactive figures is available at \url{https://bartonicek.github.io/thesis/}.}
\emph{Documentation for \texttt{plotscaper}, the R package developed as part of this research, can be found at \url{https://bartonicek.github.io/plotscaper/}.}
\end{quote}
...
{\centering \includegraphics[width=1\linewidth]{./figures/si427} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/prim9} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/xlisp-stat} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/mondrian} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/d3-scatterplot} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/plotly-scatterplot} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/vegalite-scatterplot} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/zooming} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/panning} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/querying} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/sorting} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/barplot-spineplot} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/linked-selection} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/line-consistency} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/challenger} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/expand-scatterplot} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/geoms-bijection} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/barplot-bijection} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/barplot-notbijection} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/barplot-bijection-proportions} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/referendum-notbijection} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/referendum-bijection} 
...
{\centering \includegraphics[width=1\linewidth]{_main_files/figure-latex/unnamed-chunk-14-1} 

}

\caption{A simple barplot, based on data partitioned by a single categorical variable.}\label{fig:unnamed-chunk-14}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{_main_files/figure-latex/unnamed-chunk-16-1} 

}

\caption{Stacked barplot with data partitioned by the product of two categorical variables.}\label{fig:unnamed-chunk-16}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{_main_files/figure-latex/unnamed-chunk-17-1} 

}

\caption{A stacked barplot, produced automatically as a `ggplot2` default.}\label{fig:unnamed-chunk-17}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{./figures/spineplot-tree} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/barplot-preorder} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/barplot-preorder2} 
...
{\centering \includegraphics[width=0.75\linewidth]{./figures/graphs-cosplayers} 
...
\begin{center}\includegraphics[width=1\linewidth]{./figures/grammar-boxplot} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{./figures/grammar-scatterplot} \end{center}
...
{\centering \includegraphics[width=1\linewidth]{./figures/grammar-barplot-counts} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/grammar-barplot-means} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/grammar-barplot-maximums} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/grammar-dodging-layering} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/stacking-vs-dodging} 
...
{\centering \includegraphics[width=0.6\linewidth]{./figures/category-two} 
...
{\centering \includegraphics[width=0.75\linewidth]{./figures/barplot-preorder3} 
...
{\centering \includegraphics[width=0.6\linewidth]{./figures/functor} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/barplot-preorder4} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/monoids-groups-inverses} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/lineplot-monotonicity} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/ggplot2-linecounts} 
...
\begin{center}\includegraphics[width=1\linewidth]{_main_files/figure-latex/unnamed-chunk-29-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{_main_files/figure-latex/unnamed-chunk-30-1} \end{center}
...
{\centering \includegraphics[width=1\linewidth]{figures/plotscaper_example1} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/plotscaper-example2} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/ggplot-histogram-aes} 

}

\caption{A simple `ggplot2` histogram}\label{fig:unnamed-chunk-40}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{./figures/ggplot-histogram-aes2} 

}

\caption{Histogram with custom breaks}\label{fig:unnamed-chunk-42}
\end{figure}
...
List of 2
 $ :List of 2
  ...
  .. ..$ id       : 'scalar' chr "7ebcee61-6b83-4fd7-a72a-a2944ea5c9b3"
 $ :List of 2
  ..$ type: chr "add-plot"
  ..$ data:List of 3
  .. ..$ type     : 'scalar' chr "bar"
  .. ..$ variables: chr "cyl"
  .. ..$ id       : 'scalar' chr "8a08c8c1-5c7c-438c-afa1-c366a30c8416"
\end{verbatim}
...
{\centering \includegraphics[width=1\linewidth]{./figures/model_diagram} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/scene_diagram} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/plot_diagram} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/hierarchical_data} 
...
603 milliseconds has elapsed(86.14 milliseconds in dog years)
804 milliseconds has elapsed(114.86 milliseconds in dog years)
1005 milliseconds has elapsed(143.57 milliseconds in dog years)
\end{verbatim}
...
{\centering \includegraphics[width=1\linewidth]{./figures/transient-persisent-product} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/example-cases-days} 
...
\NormalTok{df }\SpecialCharTok{|\textgreater{}}
  ...
  \CommentTok{\# Add barplot with y{-}axis is weighted by cases}
  ...
  \CommentTok{\# Mark short{-}term cases green}
  \FunctionTok{assign\_cases}\NormalTok{(}\FunctionTok{which}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{stay\_category }\SpecialCharTok{==} \StringTok{"short"}\NormalTok{), }\DecValTok{1}\NormalTok{) }\SpecialCharTok{|\textgreater{}} 
  \CommentTok{\# Mark long{-}term cases red}
  \FunctionTok{assign\_cases}\NormalTok{(}\FunctionTok{which}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{stay\_category }\SpecialCharTok{==} \StringTok{"long"}\NormalTok{), }\DecValTok{2}\NormalTok{) }\SpecialCharTok{|\textgreater{}} 
  \FunctionTok{render}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=1\linewidth]{./figures/example-cases-stay-cat} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/example-cases-avg-days} 

}

\caption{Log-transforming the y-axis (the average number of days) in the scatterplot clearly shows that patients cluster into three different groups.}\label{fig:example-cases-avg-days}
\end{figure}

Now we can clearly see the gaps between the three different distributions along the y-axis.
\textgreater{} Try querying the points near the y-axis gaps by pressing the \texttt{Q} key and hovering over them. You should observe that the gaps roughly span the 60-90 day and 150-210 day ranges, corresponding to 2-3 months and 5-7 months, respectively.
...
\NormalTok{schema }\OtherTok{\textless{}{-}}\NormalTok{ df }\SpecialCharTok{|\textgreater{}}
  ...
  \CommentTok{\# Again, make sure to weigh the y{-}axis}
  \FunctionTok{add\_histogram}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"days"}\NormalTok{, }\StringTok{"days"}\NormalTok{)) }\SpecialCharTok{|\textgreater{}} 
   \CommentTok{\# Set histogram binwidth to 20 days}
  \FunctionTok{set\_parameters}\NormalTok{(}\StringTok{"histogram1"}\NormalTok{, }\AttributeTok{width =} \DecValTok{20}\NormalTok{)}
...
{\centering \includegraphics[width=1\linewidth]{./figures/example-cases-days-time} 

}

\caption{More complex figure, used for exploring how the number of cases has changed over time.}\label{fig:example-cases-days-time}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{./figures/example-cases-days-time-zoom} 

}

\caption{In 2022, the distribution of the days spent in treatment had a fatter tail compared with 2010, suggesting that there were more patients who spent long time in care.}\label{fig:example-cases-days-time-zoom}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{./figures/example-cases-days-children} 

}

\caption{Figure used for exploring the trends among children and adolescents over time.}\label{fig:example-cases-days-children}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{./figures/example-cases-days-children-marked} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/example-cases-days-age} 

}

\caption{Figure used for exploring the trends among age categories over time.}\label{fig:example-cases-days-age}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{./figures/example-cases-diagnosis} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/example-cases-diagnosis-time} 

}

\caption{Proportion of cases and days in treatment seemed to remain fairly constant across diagnoses, except for schizophrenia which had a marked increasing trend in days spent in treatment.}\label{fig:example-cases-diagnosis-time}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{./figures/example-cases-diagnosis-max} 
...
\subsubsection{Plot types and aesthetics}\label{plot-types-and-aesthetics}
...
Currently, all plots are specified nominally\footnote{Meaning that, for instance, to add a scatterplot, we call the \texttt{add\_scatterplot} function.}. While a full declarative plot specification in R would be appealing, implementing such a system has presented challenges, and the issue will be discussed in more depth in Section \ref{declarative-schemas}. This somewhat limits the package's extensibility, however, users familiar with TypeScript can still create arbitrary new plot types using \texttt{plotscape} code. Firther, most plot types support a restricted set of aesthetics for data mapping. For example, scatterplots are limited to the x-axis, y-axis, and point size. While a potential future extension of the package could introduce additional aesthetics such as shape, color must remain excluded as it is reserved for indicating user selections.
...
{\centering \includegraphics[width=1\linewidth]{./figures/relations} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/functions-subset} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/functions-types} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/bijection-composition} 
...
{\centering \includegraphics[width=1\linewidth]{./figures/family-tree} 
...
{\centering \includegraphics[width=0.75\linewidth]{./figures/category-two} 
...
{\centering \includegraphics[width=0.33\linewidth]{./figures/monoid-category} 
...
{\centering \includegraphics[width=0.5\linewidth]{./figures/group-category} 
